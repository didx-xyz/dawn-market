...
//> using dep com.softwaremill.sttp.tapir::tapir-http4s-server:1.9.10
//> using dep org.http4s::http4s-ember-server:0.23.24
//> using dep com.softwaremill.sttp.tapir::tapir-swagger-ui-bundle:1.9.10
//> using dep com.softwaremill.sttp.tapir::tapir-json-circe:1.9.10
//> using dep ch.qos.logback:logback-classic:1.4.14
//> using test.dep com.softwaremill.sttp.tapir::tapir-sttp-stub-server:1.9.10
