...
//> using dep com.github.pureconfig::pureconfig-core:0.17.5
//> using dep com.github.pureconfig::pureconfig-cats-effect:0.17.5

//> using dep com.softwaremill.sttp.client3::core:3.9.2
//> using dep com.softwaremill.sttp.client3::circe:3.9.2
//> using dep com.softwaremill.sttp.client3::async-http-client-backend-cats:3.9.2
//> using dep dev.mn8::castanet:0.1.14
//> using dep com.softwaremill.sttp.tapir::tapir-http4s-server:1.9.9
//> using dep org.http4s::http4s-ember-server:0.23.25
//> using dep com.softwaremill.sttp.tapir::tapir-swagger-ui-bundle:1.9.9
...
//> using test.dep com.softwaremill.sttp.client3::circe:3.9.2
//> using dep com.github.geirolz::erules-core:0.1.1
//> using dep org.http4s::http4s-blaze-server:0.23.16
//> using dep org.http4s::http4s-dsl:0.23.25

//> using dep org.slf4j:slf4j-nop:2.0.11 